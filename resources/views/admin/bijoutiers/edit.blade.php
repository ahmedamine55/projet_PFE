...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.bijoutier.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.bijoutiers.update", [$bijoutier->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="nom">{{ trans('cruds.bijoutier.fields.nom') }}</label>
                <input class="form-control {{ $errors->has('nom') ? 'is-invalid' : '' }}" type="text" name="nom" id="nom" value="{{ old('nom', $bijoutier->nom) }}" required>
                @if($errors->has('nom'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('prenom') ? 'is-invalid' : '' }}" type="text" name="prenom" id="prenom" value="{{ old('prenom', $bijoutier->prenom) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mobile') ? 'is-invalid' : '' }}" type="text" name="mobile" id="mobile" value="{{ old('mobile', $bijoutier->mobile) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{{ old('description', $bijoutier->description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('facebook') ? 'is-invalid' : '' }}" type="text" name="facebook" id="facebook" value="{{ old('facebook', $bijoutier->facebook) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('instagram') ? 'is-invalid' : '' }}" type="text" name="instagram" id="instagram" value="{{ old('instagram', $bijoutier->instagram) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('twitter') ? 'is-invalid' : '' }}" type="text" name="twitter" id="twitter" value="{{ old('twitter', $bijoutier->twitter) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('web') ? 'is-invalid' : '' }}" type="text" name="web" id="web" value="{{ old('web', $bijoutier->web) }}">
                @if($errors->has('web'))
                    <div class="invalid-feedback">
                        {{ $errors->first('web') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $bijoutier->email) }}" required>
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('type_payement') ? 'is-invalid' : '' }}" name="type_payement" id="type_payement">
                    ...
                    @foreach(App\Models\Bijoutier::TYPE_PAYEMENT_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('type_payement', $bijoutier->type_payement) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('paye') ? 'is-invalid' : '' }}" name="paye_id" id="paye_id" required>
                    @foreach($payes as $id => $paye)
                        <option value="{{ $id }}" {{ (old('paye_id') ? old('paye_id') : $bijoutier->paye->id ?? '') == $id ? 'selected' : '' }}>{{ $paye }}</option>
                    @endforeach
                </select>
                @if($errors->has('paye'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('password') ? 'is-invalid' : '' }}" type="text" name="password" id="password" value="{{ old('password', $bijoutier->password) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('prix') ? 'is-invalid' : '' }}" type="text" name="prix" id="prix" value="{{ old('prix', $bijoutier->prix) }}" required>
                @if($errors->has('prix'))
                    <div class="invalid-feedback">
                        {{ $errors->first('prix') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('qantity') ? 'is-invalid' : '' }}" type="number" name="qantity" id="qantity" value="{{ old('qantity', $bijoutier->qantity) }}" step="1" required>
