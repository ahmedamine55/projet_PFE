...
@section('content')
    <div>
        <a href="{{ route('admin.check-articles.index') }}" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">New articles</a>
        <a href="{{ route('admin.articleViewOld') }}" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true">Old articles</a>
    </div>
    <br><br>
<div class="card">
    <div class="card-header">
        {{ trans('New Articles') }} {{ trans('global.list') }}
    </div>
                ...
                <tbody>
                    @foreach($articles as $key => $article)
                        <tr data-entry-id="{{ $article->id }}">
                            ...
                            <td>
                                <a class="btn btn-xs btn-primary" href="{{ route('admin.changeOld', $article->id) }}">
                                    {{ trans('confirm') }}
                                </a>
                            </td>
